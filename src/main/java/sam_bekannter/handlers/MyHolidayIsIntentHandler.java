...
public class MyHolidayIsIntentHandler implements RequestHandler {

    @Override
    public boolean canHandle(HandlerInput input) {
        return input.matches(intentName("MyHolidayIsIntent"));
    }
    ...
    public Optional<Response> handle(HandlerInput input) {
        ...
        String speechText =
                String.format("%s", PhrasesAndConstants.HOLIDAY_SAVED);
