...
import static com.amazon.ask.request.Predicates.intentName;
    ...
    public class MyRelationIsIntentHandler implements RequestHandler {

        @Override
        public boolean canHandle(HandlerInput input) {
            return input.matches(intentName("MyRelationIsIntent"));
        }
        ...
        public Optional<Response> handle(HandlerInput input) {
            ...
            String speechText =
                    String.format("%s", PhrasesAndConstants.RELATION_SAVED);
