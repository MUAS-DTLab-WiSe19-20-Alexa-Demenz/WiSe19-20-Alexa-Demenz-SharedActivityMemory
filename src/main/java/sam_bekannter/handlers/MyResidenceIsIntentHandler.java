...
public class MyResidenceIsIntentHandler implements RequestHandler {

    @Override
    public boolean canHandle(HandlerInput input) {
        return input.matches(intentName("MyResidenceIsIntent"));
    }
    ...
    public Optional<Response> handle(HandlerInput input) {
        ...
        String speechText =
                String.format("%s", PhrasesAndConstants.RESIDENCE_SAVED);
