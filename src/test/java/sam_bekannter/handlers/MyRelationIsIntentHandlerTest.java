...
public class MyRelationIsIntentHandlerTest {
    private MyRelationIsIntentHandler handler;
    private final static String NAME = "Testuser";

    @Before
    public void setup() {
        handler = new MyRelationIsIntentHandler();
    }
    ...
    public void testHandle() {
        ...
        assertTrue(response.getOutputSpeech().toString().contains(PhrasesAndConstants.RELATION_SAVED));
    }
}
