...
public class WhatsMyHolidayIntentHandlerTest {
    private WhatsMyHolidayIntentHandler handler;
    private final static String NAME = "Testuser";
    private final static String HOLIDAY = "Dubai";

    @Before
    public void setup() {
        handler = new WhatsMyHolidayIntentHandler();
    }
    ...
    public void testHandle() {
        ...
        assertTrue(response.getOutputSpeech().toString().contains(PhrasesAndConstants.HOLIDAY_IS));
        assertTrue(response.getOutputSpeech().toString().contains(HOLIDAY));
    }
    ...
    public void testHandleNullObject() {
        ...
        persistentAttributes.put(NAME, byteArr);
        final Response response = TestUtil.standardTestForHandle(handler, sessionAttributes, persistentAttributes);
        assertTrue(response.getOutputSpeech().toString().contains(PhrasesAndConstants.HOLIDAY_UNKNOWN));
    }
}
