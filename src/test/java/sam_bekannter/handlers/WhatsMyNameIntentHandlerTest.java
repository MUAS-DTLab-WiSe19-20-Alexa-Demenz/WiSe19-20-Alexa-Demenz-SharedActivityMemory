...
public class WhatsMyNameIntentHandlerTest {
    private WhatsMyNameIntentHandler handler;
    private final static String NAME = "Testuser";

    @Before
    public void setup() {
        handler = new WhatsMyNameIntentHandler();
    }
    ...
    public void testHandle() {
        ...
        assertTrue(response.getOutputSpeech().toString().contains(PhrasesAndConstants.NAME_IS));
