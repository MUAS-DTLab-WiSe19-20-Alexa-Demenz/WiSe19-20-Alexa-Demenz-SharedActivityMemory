...
public class WhatsMyRelationIntentHandlerTest {
    private WhatsMyRelationIntentHandler handler;
    private final static String NAME = "Testuser";
    private final static String RELATION = "Bruder";

    @Before
    public void setup() {
        handler = new WhatsMyRelationIntentHandler();
    }
    ...
    public void testHandle() {
        ...
        assertTrue(response.getOutputSpeech().toString().contains(PhrasesAndConstants.MYRELATION_IS));
        assertTrue(response.getOutputSpeech().toString().contains(RELATION));
    }
    ...
    public void testHandleNullObject() {
        ...
        persistentAttributes.put(NAME, byteArr);
        final Response response = TestUtil.standardTestForHandle(handler, sessionAttributes, persistentAttributes);
        assertTrue(response.getOutputSpeech().toString().contains(PhrasesAndConstants.MYRELATION_UNKNOWN));
    }
}
