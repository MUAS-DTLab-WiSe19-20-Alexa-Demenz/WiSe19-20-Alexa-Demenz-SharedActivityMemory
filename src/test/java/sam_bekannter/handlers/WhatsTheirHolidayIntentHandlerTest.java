...
public class WhatsTheirHolidayIntentHandlerTest {
    private WhatsTheirHolidayIntentHandler handler;
    private final static String NAME = "Testuser";

    @Before
    public void setup() {
        handler = new WhatsTheirHolidayIntentHandler();
    }
    ...
    public void testHandleEverythingFine() {
        ...
        assertTrue(response.getOutputSpeech().toString().contains(PhrasesAndConstants.HISHOLIDAY));
    }
    ...
    public void testHandleNoSavedAttribute() {
        ...
        persistentAttributes.put(NAME, byteArr);
        final Response response = TestUtil.withInput(NAME, PhrasesAndConstants.NAME_SLOT, handler, sessionAttributes, persistentAttributes);
        assertTrue(response.getOutputSpeech().toString().contains(PhrasesAndConstants.HIS_HOLIDAY_UNKNOWN));
    }
}
