...
public class WhatsTheirResidenceIntentHandlerTest {
    private WhatsTheirResidenceIntentHandler handler;
    private final static String NAME = "Testuser";

    @Before
    public void setup() {
        handler = new WhatsTheirResidenceIntentHandler();
    }
    ...
    public void testHandleEverythingFine() {
        ...
        assertTrue(response.getOutputSpeech().toString().contains(PhrasesAndConstants.HISRESIDENCE));
    }
    ...
    public void testHandleNoSavedAttribute() {
        ...
        persistentAttributes.put(NAME, byteArr);
        final Response response = TestUtil.withInput(NAME, PhrasesAndConstants.NAME_SLOT, handler, sessionAttributes, persistentAttributes);
        assertTrue(response.getOutputSpeech().toString().contains(PhrasesAndConstants.HIS_RESIDENCE_UNKNOWN));
    }
}
